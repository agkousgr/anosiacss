 ...
 */
class Version20180520174051 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE category ADD slug VARCHAR(50) NOT NULL, CHANGE name name VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE category DROP slug, CHANGE name name VARCHAR(50) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
