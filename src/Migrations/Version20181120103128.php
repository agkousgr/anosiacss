 ...
 */
final class Version20181120103128 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE items_count items_count INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE items_count items_count INT NOT NULL');
    }
}
